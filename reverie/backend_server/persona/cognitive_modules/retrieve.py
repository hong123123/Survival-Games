...
def new_retrieve(persona, focal_points, n_count=20):
    """
  ...
  """
    ...
    for focal_pt in focal_points:
        ...
        filter_nodes = []
        exist_embedding_keys = []
        for node in nodes:
            if node[1].embedding_key in exist_embedding_keys:
                continue
            else:
                exist_embedding_keys.append(node[1].embedding_key)
