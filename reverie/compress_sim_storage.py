...
from backend_server.utils import frontend_path

def compress(sim_code):
  sim_storage = f"{frontend_path}/storage/{sim_code}"
  compressed_storage = f"{frontend_path}/compressed_storage/{sim_code}"
